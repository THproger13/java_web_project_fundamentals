...
@WebServlet(value= {"/pro/list", "/pro/insert", "/pro/read", "/pro/delete", "/pro/update", "/pro/list.json", "/pro/total"})
public class ProductController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/pro/total":
			System.out.println(gson.toJson(dao.total()));
			out.println(dao.total());
			break;
		case "/pro/list.json":
			out.println(gson.toJson(dao.list(1)));
			break;
		case "/pro/list":
